...
adminRouter.post('/seed-sample-quiz', (req: AuthenticatedRequest, res: Response): void => {
  ...
  const sampleQuiz = db.createQuiz({
    ...
    description: 'Batch 99 clinical module examination focusing on early diagnostic workup, ECG interpretation, and evidence-based pharmacotherapy.',
    subject_id: internalMed.id,
    topic_id: topicId,
    difficulty: 'Curriculum Core',
